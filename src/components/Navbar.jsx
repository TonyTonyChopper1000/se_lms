        ...
        {isLoggedIn ? (
          <div className="flex items-center space-x-4">
            <div className="flex items-center">
              ...
              <Link to="/profile" className="flex items-center justify-center h-8 w-8 rounded-full bg-orange-100 hover:bg-orange-200 transition-colors">
          ...
          <div className="flex items-center space-x-4">
            <Link to="/login" className="text-gray-700 hover:text-orange-500 transition-colors font-medium">
              Login
            </Link>
